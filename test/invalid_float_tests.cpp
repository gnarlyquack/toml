...
TEST(invalid_float_tests, test_exp_trailing_us)
{
    ...
    const vector<Error> expected{{ 1, 19, "'_' must separate digits in exponential part of decimal number: 1e_23_" },};
...
TEST(invalid_float_tests, test_exp_double_e_2)
{
    ...
    const vector<Error> expected{{ 1, 18, "Invalid exponential part of decimal number: 1e2e3" },};
...
TEST(invalid_float_tests, test_double_point_2)
{
    ...
    const vector<Error> expected{{ 1, 18, "Invalid fractional part of decimal number: 0.1.2" },};
...
TEST(invalid_float_tests, test_us_after_point)
{
    ...
    const vector<Error> expected{{ 1, 18, "'_' must separate digits in fractional part of decimal number: 1._2" },};
...
TEST(invalid_float_tests, test_leading_point)
{
    ...
    const vector<Error> expected{{ 1, 17, "Missing whole part of decimal number." },};
...
TEST(invalid_float_tests, test_trailing_us_exp)
{
    ...
    const vector<Error> expected{{ 2, 19, "'_' must separate digits in whole part of decimal number: 1_" },{ 4, 20, "'_' must separate digits in fractional part of decimal number: 1.2_" },};
...
TEST(invalid_float_tests, test_leading_point_plus)
{
    ...
    const vector<Error> expected{{ 1, 23, "Missing whole part of decimal number." },};
...
TEST(invalid_float_tests, test_exp_double_us)
{
    ...
    const vector<Error> expected{{ 1, 17, "'_' must separate digits in exponential part of decimal number: 1e__23" },};
