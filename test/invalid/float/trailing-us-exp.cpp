TEST(invalid_float_tests, test_trailing_us_exp)
{
    ...
    const vector<Error> expected{{ 2, 19, "'_' must separate digits in whole part of decimal number: 1_" },{ 4, 22, "'_' must separate digits in fractional part of decimal number: 1.2_" },};
